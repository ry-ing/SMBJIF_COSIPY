...
' GENERAL INFORMATION ' 
dt = 86400 #86400                                       # Time step in the input files [s]
max_layers = 200    #200                            # Max. number of layers, just for the restart file
...
initial_glacier_height = 400.0                   # Initial glacier height without snowlayers ORIGINALLY 40
...
mult_factor_RRR = 0.738   #1.0                           # multiplication factor for RRR
...
albedo_fresh_snow = 0.8735 #0.85                        # albedo of fresh snow [-] (Moelg et al. 2012, TC)
albedo_firn = 0.498 #0.55                              # albedo of firn [-] (Moelg et al. 2012, TC)
albedo_ice = 0.406 #0.3                               # albedo of ice [-] (Moelg et al. 2012, TC)
albedo_mod_snow_aging = 4.3 #22                      # effect of ageing on snow albedo [days] (Oerlemans and Knap 1998, J. Glaciol.)
albedo_mod_snow_depth = 10.71 #3                       # effect of snow depth on albedo [cm] (Oerlemans and Knap 1998, J. Glaciol.)
...
roughness_fresh_snow = 0.496   #0.24                  # surface roughness length for fresh snow [mm] (Moelg et al. 2012, TC)
roughness_ice = 2.46      #1.7                      # surface roughness length for ice [mm] (Moelg et al. 2012, TC)
roughness_firn = 1.79  #4.0                          # surface roughness length for aged snow [mm] (Moelg et al. 2012, TC)
...
surface_emission_coeff = 0.975                  # surface emission coefficient [-]

...
static_folder = '/data/ggp21rni/static_data/'

tile = True
aggregate = True

### input digital elevation model (DEM)
dem_path_tif = static_folder + 'DEM/JIF_STRM-1arc_DEM.tif'   #static_folder + 'DEM/juneau_dem.tif'
### input shape of glacier or study area, e.g. from the Randolph glacier inventory
shape_path = static_folder + 'shapefiles/Taku_Glacier_Boundaries.shp'
### path were the static.nc file is saved
output_path = static_folder + 'taku_static_0-03.nc'

### to shrink the DEM use the following lat/lon corners
longitude_upper_left = '-135.195'      #'-134.67'
latitude_upper_left = '59.561'       # '58.88'
longitude_lower_right = '-133.350'     # '-133.90'
latitude_lower_right = '58.152'      #'58.387'

### to aggregate the DEM to a coarser spatial resolution
aggregate_degree = '0.03' #0.003 normally 0.01

...
shape_path = static_folder + 'shapefiles/Juneau_extent_2019_RGIID.shp'
### path were the static.nc file is saved
output_path = static_folder + 'JIF_static.nc'

### to shrink the DEM use the following lat/lon corners
longitude_upper_left = '-135.70'      #'-134.67'
latitude_upper_left = '59.90'       # '58.88'
longitude_lower_right = '-133.25'     # '-133.90'
latitude_lower_right = '58.20'      #'58.387'

### to aggregate the DEM to a coarser spatial resolution
aggregate_degree = '0.01'

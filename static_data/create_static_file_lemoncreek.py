...
shape_path = static_folder + 'shapefiles/lc_shape.shp'
### path were the static.nc file is saved
output_path = static_folder + 'lemoncreek_static.nc'

### to shrink the DEM use the following lat/lon corners
longitude_upper_left = '-134.398'
latitude_upper_left = '58.42'
longitude_lower_right = '-134.315'
latitude_lower_right = '58.31'

### to aggregate the DEM to a coarser spatial resolution
aggregate_degree = '0.01' #0.003

...
from utilities.aws2cosipy.greenland_project.aws2cosipyConfig import *
...
def create_2D_input(cs_file, cosipy_file, static_file, start_date, end_date, x0=None, x1=None, y0=None, y1=None):
    ...
    date_parser = lambda x: dateutil.parser.parse(x, ignoretz=True)
    df = pd.read_csv(cs_file, 
        delimiter=delimiter, index_col=['TIMESTAMP'])
...
cs_file = '/home/ggp21rni/cosipy/utilities/aws2cosipy/greenland_project/KAN_L_ERA_august_raw.csv'
cosipy_file = '/home/ggp21rni/cosipy/utilities/aws2cosipy/greenland_project/KAN_L_COSIPY_input.nc'
static_file = '/home/ggp21rni/cosipy/utilities/createStatic/greenland_project/promice_static.nc'
start_date = '01/08/2022 01:00'
end_date = '24/08/2022 23:00'
print(cs_file)
create_2D_input(cs_file, cosipy_file, static_file, start_date, end_date, x0=None, x1=None, y0=None, y1=None)
